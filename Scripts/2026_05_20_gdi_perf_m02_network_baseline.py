...
Uso:
  python Scripts/2026_05_20_gdi_perf_m02_network_baseline.py --static
  python Scripts/2026_05_20_gdi_perf_m02_network_baseline.py --live --base-url https://localhost:44388 --user X --password Y

Saída: .cursor/context/2026_05_20_perf-m02-resultado.json
"""
...
OUT_JSON = os.path.join(ROOT, ".cursor", "context", "2026_05_20_perf-m02-resultado.json")
