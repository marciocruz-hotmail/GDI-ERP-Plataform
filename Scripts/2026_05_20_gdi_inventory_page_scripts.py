...
Uso (raiz do repo):
  ...
  python Scripts/2026_05_20_gdi_inventory_page_scripts.py --json
  python Scripts/2026_05_20_gdi_inventory_page_scripts.py --markdown
  python Scripts/2026_05_20_gdi_inventory_page_scripts.py --controllers
...
def main():
    ...
    ap.add_argument(
        "--out",
        default=os.path.join(BASE, ".cursor", "context", "2026_05_20_layout-scripts-inventario.json"),
    ...
    payload = {
        ...
        "script": "2026_05_20_gdi_inventory_page_scripts.py",
