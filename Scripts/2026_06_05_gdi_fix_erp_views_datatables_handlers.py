# -*- coding: utf-8 -*-
"""Lote L — error.dt / xhr.dt em Areas/g, qa, a."""
import glob
...
_PATCH_MOD = os.path.join(_REPO, "Scripts", "2026_06_05_gdi_fix_gc_views_datatables_handlers.py")
DEFAULT_AREAS = ("g", "qa", "a")


def load_patch():
    spec = importlib.util.spec_from_file_location("gdi_dt_patch", _PATCH_MOD)
...
def run_area(patch_fn, area):
    base = os.path.join(_REPO, "Areas", area, "Views")
