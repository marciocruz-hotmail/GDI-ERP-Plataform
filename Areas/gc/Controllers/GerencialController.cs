...
namespace GdiPlataform.Areas.gc.Controllers
{
    public class GerencialController : Controller
    {
        ...
        public ActionResult IndexPainelComercialGerencial()
        {
            ...
            sentencaSqlDiario += "   AND gc_movimentos.datahora_aprovacao BETWEEN ";
            ...
            sentencaSqlMes += "   AND gc_movimentos.datahora_aprovacao BETWEEN ";
            ...
            sentencaSqlPedidosEntregues += "   AND gc_movimentos.datahora_aprovacao BETWEEN ";
