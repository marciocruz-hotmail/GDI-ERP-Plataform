...
**Tempus:** partial na view onde modais usam `jsDatepicker` (Relatórios Comercial/Regulamentação/Financeiros; ver `2026_05_22_layout-scripts-tempus-hosts.md`).
...
**Inventário:** `Scripts/2026_05_22_gdi_inventory_layout_no_datatables.py` (todas as views `_Layout` sem DT).
...
2. Confirmar libs dos modais (matriz `2026_05_22_layout-scripts-matriz-modais.md`).
...
5. Atualizar `Scripts/2026_05_22_gdi_page_scripts_smoke_manifest.py` e correr verify.
...
python Scripts/2026_05_22_gdi_inventory_index_no_datatables.py
```
...
- Fase 3 infra: `2026_05_22_layout-scripts-fase3-infra.md`
