...
- **~170 inits** sem bloco `language:` → herdam defaults (auditoria: `Scripts/2026_05_22_gdi_audit_datatables_language.py`).
...
Ver **`.cursor/context/2026_05_22_datatables-filtro-obrigatorio-mensagem.md`** — hook global evita «Carregando...» antes da primeira pesquisa.
