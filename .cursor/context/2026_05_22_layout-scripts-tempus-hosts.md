...
**Scripts:** `Scripts/2026_05_22_gdi_inventory_tempus_hosts.py`, `Scripts/2026_05_22_gdi_apply_tempus_partials.py`
...
2. Se for hub novo, validar com `python Scripts/2026_05_22_gdi_inventory_tempus_hosts.py`.
