# Inventario LibDataSets (Fase 0) — ARQUIVADO

> **Substituido por:** [2026_05_20_lookups-libdatasets.md](./2026_05_20_lookups-libdatasets.md) — inventario de **`ILookupQueryService`** (59 metodos `Get*`, regenerado por `Scripts/2026_05_20_gdi_inventory_libdatasets.py`).
>
> **Motivo:** `Lib/LibDataSets.cs` foi **removido** na Onda 6b (2026-05-20). Este ficheiro permanece apenas como **historico** da Fase 0 (`Load*` / `contextoModel`). Nao usar para decisoes de implementacao atuais.

---

Gerado originalmente por `Scripts/2026_05_20_gdi_inventory_libdatasets.py` a partir de `Lib/LibDataSets.cs` (ficheiro ja nao existe no repo).
