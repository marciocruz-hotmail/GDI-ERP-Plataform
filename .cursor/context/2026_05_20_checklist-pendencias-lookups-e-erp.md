...
- [x] **1.6.1** Contrato JSON + actions — ver `.cursor/context/2026_05_20_lookups-typeahead-ajax-pedidos.md`
...
- [x] Inventário: `python Scripts/2026_05_20_gdi_inventory_datatables_g_area.py` — 27 métodos; Fases 13–16 já aplicadas
