...
**Data:** 2026-05-20  
**Fonte:** grep `mainModal.load` + inventário `2026_05_20_layout-scripts-inventario.json`  
...
- JSON completo: `2026_05_20_layout-scripts-inventario.json`  
- Checklist: `2026_05_20_checklist-performance-erp.md` (G-PERF-20)
