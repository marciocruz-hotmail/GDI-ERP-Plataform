...
> Lotes completos Fase 4: **`2026_05_20_layout-scripts-fase4-optout.md`** (inclui lote B Treinamentos + portal).
...
**Tempus:** continua fora do `_Layout`; partials `_LayoutHead/ScriptsTempus` nas views host (ver `2026_05_20_layout-scripts-tempus-hosts.md`).
...
Script: `python Scripts/2026_05_20_gdi_page_scripts_smoke_manifest.py --markdown`
...
- Matriz modais: `2026_05_20_layout-scripts-matriz-modais.md`
- Contrato: `2026_05_20_layout-scripts-contrato-flags.md`
- Checklist performance: `2026_05_20_checklist-performance-erp.md` § G-PERF-M02
