...
**Script:** `Scripts/2026_05_22_gdi_perf_m02_network_baseline.py`  
**JSON:** `2026_05_21_perf-m02-resultado.json`
...
> Valores exactos: correr `python Scripts/2026_05_22_gdi_perf_m02_network_baseline.py --static` e abrir o JSON gerado.
...
python Scripts/2026_05_22_gdi_perf_m02_network_baseline.py --live --base-url https://SEU_HOST_HOMOLOG
```
...
- `2026_05_22_checklist-performance-erp.md` § Etapa 0 e G-PERF-M02
- `2026_05_22_layout-scripts-fase5-lazy-modal.md`
