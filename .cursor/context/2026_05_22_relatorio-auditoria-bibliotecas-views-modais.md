...
**Ferramentas:** `Scripts/2026_05_22_gdi_inventory_page_scripts.py`, `Scripts/2026_05_22_gdi_cross_audit_view_libraries.py`, `Scripts/2026_05_22_gdi_audit_tempus_loading.py`  
**Dados brutos:** `.cursor/context/2026_05_21_cross_audit_view_libraries.json`, `2026_05_21_layout-scripts-inventario.json`
...
1. **Executar** `python Scripts/2026_05_22_gdi_apply_tempus_partials.py` nos 22 hosts documentados (+ validar com `2026_05_22_gdi_audit_tempus_loading.py` → 0 hosts em falta).
...
3. **Smoke manual** (matriz em `2026_05_22_layout-scripts-matriz-modais.md`): IndexPedido, FinanceiroLancamentos, Ged, Relatórios ANP, Parametros.
...
1. **`python Scripts/2026_05_22_gdi_cross_audit_view_libraries.py`** no checklist pré-publish; **exit code 1** se existir `critical_hosts`.
2. Atualizar `2026_05_22_layout-scripts-contrato-flags.md` — corrigir “Tempus: 3 views” (inventário real: **41–42**).
...
| Ficheiro | Uso |
|----------|-----|
| `Scripts/2026_05_22_gdi_cross_audit_view_libraries.py` | Reexecutar auditoria |
| `.cursor/context/2026_05_21_cross_audit_view_libraries.json` | Detalhe por view (`gaps`, `components`, `needs`) |
| `Scripts/2026_05_22_gdi_audit_tempus_loading.py` | Foco Tempus |
| `Scripts/2026_05_22_gdi_apply_tempus_partials.py` | Correção em massa (22 hosts) |
...
| Data | Resumo |
|------|--------|
| 2026-05-21 | Auditoria cruzada 242 views: 16 hosts CRITICAL (14 Tempus sem partial, Parametros/Index sem DT, GedSGQ/IndexPops sem jstree); relatório e script `2026_05_22_gdi_cross_audit_view_libraries.py`; proposta integrar TempusDominus nos partials opcionais do layout. |
