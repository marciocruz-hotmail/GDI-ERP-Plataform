...
**Documentos relacionados:** `2026_05_22_checklist-performance-erp.md` (etapas executáveis), `BACKLOG-DEV.md` (IDs G-PERF / G-DT / G-PROD), baseline DevTools no checklist §0.
...
| 3 | `Scripts/2026_05_22_gdi_inventory_datatables_memory_paging.py` | 6× `GetDados*` **PENDENTE** | Grids de cadastro/parâmetros degradam com dados | Aplicar `LibDataTableSqlPaging` (padrão Atendimentos L78) | **Alta** | Médio | Baixo |
...
| `2026_05_22_gdi_inventory_datatables_memory_paging.py` | Regressão paginação |
